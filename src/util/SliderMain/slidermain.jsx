...
let sliderWidth = ref.current?.offsetWidth || 0;
...
setInterval(() => {
    ...
    return <div className={classes.sliderMainWrap}> {/*slider*/}
        ...
        <button className={classes.sliderMainPrew} onClick={prevSlider}> &#10148 </button>
        <button className={classes.sliderMainForw} onClick={nextSlider}> +++ </button>
    </div>
}